 ...
 */
class CRM_Eventinstallment_Upgrader_Base {

  /**
   * @var CRM_Eventinstallment_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Eventinstallment_Upgrader(
        'com.skvare.eventinstallment',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Eventinstallment_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Eventinstallment_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
